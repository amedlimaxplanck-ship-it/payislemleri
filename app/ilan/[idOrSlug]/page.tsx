...
export default function SahibindenTemplate() {
    ...
    const fetchIlan = async () => {
        try {
            ...
            if (res.ok) {
                ...
                setData(ilanData);
                logAction("İlana Giriş Yaptı", "Eleman vitrini inceliyor.", ilanData);
                setLoading(false);
            } else {
                setError(true);
                setLoading(false);
    ...
    const handleCompleteOrder = async () => {
        ...
        try {
            // Upload to ImgBB (using legacy key)
    ...
    if (loading) return (
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', fontFamily: 'sans-serif', background: '#f3f4f7' }}>
            İlan yükleniyor...
        </div>
    );
    ...
    if (error) return (
        <div className="shb-body">
            <div className="shb-error-card">
                ...
                <a href="https://www.sahibinden.com" className="error-btn">Ana Sayfaya Dön</a>
            </div>
        </div>
    );
            ...
            <div className="app-container">
                ...
                {isCompleted ? (
                    <div style={{ textAlign: 'center', padding: '40px 10px', background: '#fff', minHeight: '300px', margin: '20px' }}>
                        <h2 style={{ color: '#00a651', marginBottom: '15px', fontSubnet: '24px' }}>Siparişiniz Başarılı!</h2>
                    ...
                    <>
                        ...
                        {mevcutAdim === 3 && (
                            <div id="step3">
                                ...
                                <div className="s3-kvkk-text">
                                    Kişisel verilerin korunması hakkında detaylı bilgiye <a href="#" onClick={(e) => e.preventDefault()}>buradan</a> ulaşabilirsiniz.
                                </div>
                            </div>
                        )}
